...
const drawScene = (gl, parameters, buffers, deltaTime, texture) => {
    ...
    glMatrix.mat4.rotate(modelViewMatrix, modelViewMatrix, squareRotation * 0.6, [0, 1, 0]);
    glMatrix.mat4.rotate(modelViewMatrix, modelViewMatrix, squareRotation * 0.25, [1, 0, 0]);
